...
public class AccountController {
    ...
    // 모임서비스 전체 조회
    @PostMapping("/account")
    public List<AccountListResDto> accountList(@RequestBody Map<String, Long> memberIdxMap) {
        Long memberIdx = memberIdxMap.get("memberIdx");
        List<AccountListResDto> accountListResDtos = accountService.accountList(memberIdx);
